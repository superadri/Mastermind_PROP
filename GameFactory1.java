...
public class GameFactory {
		...
		while(nolimit) {
			...
			if( r.user_exists(username) ){
				...
				newgame(username);
                      ...
                      // r.set_continueGame ('1',username,respuestas,2.33,"GGG","HARD","CM");
    ...
    private void newgame(String username) {
        ...
        //te paso player2 como MACHINE
         ...
         else if (maquina) {mastermind = new Mastermind(player2,player2,respuesta,this);}
    ...
    private void continuegame(String username) {
       System.out.println("ContinueGame");
        ...
        String rol = p.getRol();
        if (rol.equals("CM")) {
            String computerCM = username;
            String computerCB = "MACHINE";
        }
        else {
            String computerCB = username;
            String computerCM = "MACHINE";
        }
