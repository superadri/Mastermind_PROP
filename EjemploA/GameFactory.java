...
public class GameFactory {
	...
	private boolean soyCM,soyCB,maquina;
...
*/
	...
	public GameFactory(CtrlPresentacio ctrl) throws IOException {
		this.r = new Register();
	...
	public void menu() throws IOException{
		...
		ctrl.setVisibleAddUser();	
	}
	
	public void setUser(String user) throws IOException {
		// TODO Auto-generated method stub
		username = user;
		ctrl.setNotVisibleAddUser();
		questionUser();
	}
	

    private void questionUser() throws IOException {
    	if( r.user_exists(username) ){
			System.out.println("Cargando Datos de "+username+"...");
			if(r.game_start_user(username)){
				ctrl.setQuestionToContinue();
			} else {
	...
	public void newGame() {
		System.out.println("newGame"+username);
		newgame(username);
	}

	public void continueGame() throws IOException {
		ctrl.setNoQuestionToContinue();
		System.out.println("continueGame"+username);
		continuegame(username);	
	}
	

	public void setNewGame(String rol, String difficulty) throws IOException {
		// TODO Auto-generated method stub
		ctrl.setNoQuestionNewGame();
        String player1 = username;
        String player2 = "MACHINE";
		soyCM = false;
		soyCB = false;
        maquina = false;
		if ( rol.equals("CM") ) { soyCM = true; }
        else if ( rol.equals("CB") ) { soyCB = true; }
        else if ( rol.equals("MACHINE") ) { maquina = true; }
    ...
    private void newgame(String username) {
    	ctrl.setQuestionNewGame();
        System.out.println("Creando nueva partida...");

    }

    private void continuegame(String username) throws IOException {
